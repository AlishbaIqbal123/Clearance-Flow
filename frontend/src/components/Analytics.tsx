...
export const Analytics = ({ user }: { user: any }) => {
  ...
  return (
    <div className="space-y-4 lg:space-y-3.5 sm:space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-1000 lg:pb-10 pb-20">
      ...
      {/* Navigation Tabs */}
      <div className="flex items-center gap-1.5 sm:gap-3 p-1 sm:p-1.5 bg-card/60 backdrop-blur-3xl rounded-xl sm:rounded-[2rem] border border-foreground/5 max-w-lg w-full shadow-soft">
        <button
          onClick={() => setActiveTab('overview')}
          className={`flex-1 py-2 px-2 sm:py-2.5 sm:px-4 rounded-lg sm:rounded-[1.5rem] text-[9px] sm:text-[10px] font-black uppercase tracking-wider sm:tracking-widest transition-all duration-500 ${
            activeTab === 'overview'
        ...
        >
          <span className="flex items-center justify-center gap-1.5 sm:gap-2">
            ...
            <span className="hidden sm:inline">Department </span>Standings
          </span>
        </button>
        <button
        ...
        >
          <span className="flex items-center justify-center gap-1.5 sm:gap-2">
            ...
            <span className="hidden sm:inline">Cohort </span>Trends
          </span>
        </button>
      </div>
