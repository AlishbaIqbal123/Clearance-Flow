        ...
        {activePortal === 'student' ? (
          <div className="min-h-screen lg:h-full w-full flex animate-in fade-in duration-700">
            ...
            <div className="hidden lg:flex w-[45%] h-full bg-[#1F5FAF] relative overflow-hidden flex-col justify-center p-12 xl:p-20">
               ...
               {/* Floating Sparkles/Particles Effect */}
               <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
                  {[...Array(12)].map((_, i) => {
                     const size = [4, 6, 8, 12, 10][i % 5];
                     const left = [10, 25, 40, 55, 70, 85, 95, 15, 35, 50, 65, 80][i];
                     const delay = i * 1.8;
                     const duration = 12 + (i % 4) * 4;
                     return (
                        <div 
                           key={i}
                           className="absolute rounded-full bg-white/45 blur-[1px] animate-particle-sway"
                           style={{
                              width: `${size}px`,
                              height: `${size}px`,
                              left: `${left}%`,
          ...
          <div className="min-h-screen lg:h-full w-full flex animate-in fade-in duration-700 bg-background">
            ...
            <div className="hidden lg:flex w-[45%] h-full bg-[#1e293b] relative overflow-hidden flex-col justify-center p-12 xl:p-20 text-white">
                ...
                {/* Floating Amber Sparkles/Particles Effect */}
                <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
                   {[...Array(12)].map((_, i) => {
                      const size = [4, 6, 8, 12, 10][i % 5];
                      const left = [10, 25, 40, 55, 70, 85, 95, 15, 35, 50, 65, 80][i];
                      ...
                      return (
                         <div 
                            key={i}
                            className="absolute rounded-full bg-amber-400/35 blur-[1px] animate-particle-sway"
                            style={{
                               width: `${size}px`,
                               height: `${size}px`,
                               left: `${left}%`,
