        ...
        {activePortal === 'student' ? (
          <div className="min-h-screen lg:h-full w-full flex animate-in fade-in duration-700">
            ...
            <div className="flex-1 min-h-screen lg:h-full bg-background relative overflow-y-auto lg:overflow-hidden flex flex-col justify-center py-8 lg:py-0">
               {/* Animated Background Image for Form Panel */}
               <div 
                 className="absolute inset-0 z-0 animate-ken-burns opacity-[0.22] dark:opacity-[0.08] pointer-events-none"
               ...
               <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
                  <div className="absolute -top-[10%] -left-[10%] w-[60%] h-[60%] rounded-full bg-primary/15 dark:bg-primary/5 blur-[120px] animate-blob-1" />
                  <div className="absolute -bottom-[10%] -right-[10%] w-[60%] h-[60%] rounded-full bg-purple-500/15 dark:bg-purple-500/5 blur-[120px] animate-blob-2" />
               </div>
               
               <div className="w-full max-w-md mx-auto p-8 space-y-8 animate-in slide-in-from-right-10 duration-1000 relative z-20">
                  <div className="space-y-6">
          ...
          <div className="min-h-screen lg:h-full w-full flex animate-in fade-in duration-700 bg-background">
            ...
            <div className="flex-1 min-h-screen lg:h-full bg-background relative overflow-y-auto lg:overflow-hidden flex flex-col justify-center py-8 lg:py-0">
               ...
               {/* Ambient Floating Blobs (Adapted to Light & Dark Mode) */}
               <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
                  <div className="absolute -top-[10%] -right-[10%] w-[60%] h-[60%] rounded-full bg-primary/15 dark:bg-primary/5 blur-[120px] animate-blob-1" />
                  <div className="absolute -bottom-[10%] -left-[10%] w-[60%] h-[60%] rounded-full bg-purple-500/15 dark:bg-purple-500/5 blur-[120px] animate-blob-2" />
               </div>
               
               <div className="w-full max-w-md mx-auto p-8 space-y-8 animate-in slide-in-from-left-10 duration-1000 relative z-20">
                  <div className="space-y-6">
                    <div className="inline-flex p-1 bg-secondary/30 backdrop-blur-3xl rounded-2xl gap-1 border border-foreground/5 w-fit">
                      <button 
                        onClick={() => setActivePortal('student')}
