    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass h-20 px-6 md:px-12 flex items-center justify-between border-b border-foreground/5 shadow-soft">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <Button 
            onClick={onLoginClick}
            className="bg-primary hover:bg-primary/90 text-white rounded-full px-6 h-10 font-black text-[10px] uppercase tracking-[0.3em] shadow-strong shadow-primary/20 active:scale-95 transition-all"
          >
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center space-y-12">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-8 animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-300 w-full justify-center">
            <Button 
              ...
              className="w-full sm:w-auto h-14 px-10 bg-foreground text-background hover:opacity-90 rounded-2xl font-black text-xs uppercase tracking-[0.4em] shadow-2xl active:scale-95 transition-all group"
            >
            ...
            <Button 
              variant="outline"
              onClick={onLoginClick}
              className="w-full sm:w-auto h-14 px-10 border-2 border-foreground/5 bg-transparent hover:bg-foreground/5 rounded-2xl font-black text-xs uppercase tracking-[0.4em] active:scale-95 transition-all"
            >
              Access Portal
            </Button>
          </div>
      ...
      <section className="py-20 md:py-40 px-6 md:px-12 relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-8 bento-card p-8 space-y-8 group overflow-hidden relative">
            <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
              <LayoutDashboard className="w-48 h-48" />
            </div>
            <div className="w-14 h-14 bg-primary/10 rounded-2xl flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-all duration-700">
          ...
          <div className="md:col-span-4 bento-card p-8 flex flex-col justify-between group bg-primary text-white border-none shadow-strong shadow-primary/20">
          ...
          <div className="md:col-span-8 bento-card p-8 flex flex-col md:flex-row items-center gap-8 group hover:bg-secondary/10 transition-colors">
             ...
             <div className="w-full md:w-auto h-32 aspect-video bg-background rounded-2xl border border-foreground/5 shadow-inner flex items-center justify-center p-6 overflow-hidden">
                <div className="flex gap-3 animate-[pulse_3s_infinite]">
                   {[1,2,3,4].map(i => <div key={i} className="w-1.5 h-10 bg-primary/20 rounded-full" />)}
                </div>
             </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-40 px-6 md:px-12 bg-secondary/10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto space-y-20">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground text-sm font-black uppercase tracking-[0.4em] opacity-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            {/* Supervisor Card */}
            <div className="glass-card p-8 space-y-6 group relative overflow-hidden border border-foreground/5 rounded-3xl hover:border-primary/30 transition-all duration-700 bg-background/40">
               <div className="absolute top-0 right-0 p-6">
                 <UserCheck className="w-8 h-8 text-primary opacity-20 group-hover:opacity-100 transition-opacity" />
               </div>
               
               <div className="flex flex-col items-center text-center space-y-6">
                  <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-primary/20 p-1.5 group-hover:scale-105 transition-all duration-700 shadow-2xl relative">
                    <img 
                      src="/supervisor.png" 
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Technical Supervisor & Mentor</p>
                  </div>
                  ...
                  <div className="flex gap-4 pt-2">
                    <a href="https://muhammadabdullahwali.vercel.app/" target="_blank" rel="noreferrer" className="w-12 h-12 bg-foreground/5 rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-all shadow-xl hover:-translate-y-1">
            ...
            {/* Developer Card */}
            <div className="glass-card p-8 space-y-6 group relative overflow-hidden border border-foreground/5 rounded-3xl hover:border-blue-500/30 transition-all duration-700 bg-background/40">
               <div className="absolute top-0 right-0 p-6">
                 <Code2 className="w-8 h-8 text-blue-500 opacity-20 group-hover:opacity-100 transition-opacity" />
               </div>
               
               <div className="flex flex-col items-center text-center space-y-6">
                  <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-blue-500/20 p-1.5 group-hover:scale-105 transition-all duration-700 shadow-2xl relative">
                    <img 
                  ...
                  <div className="flex gap-4 pt-2">
                    <a href="https://portfolio-iota-eight-92.vercel.app/" target="_blank" rel="noreferrer" className="w-12 h-12 bg-foreground/5 rounded-full flex items-center justify-center hover:bg-blue-500 hover:text-white transition-all shadow-xl hover:-translate-y-1">
                      <ExternalLink className="w-5 h-5" />
                    </a>
                  </div>
               </div>
